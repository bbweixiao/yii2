    ...
    [
        ...
        'buttons' => [
            'edit' => function ($url, $model, $key) {
                return Html::a('<i class="fa fa-edit"></i> 更新', ['adminauth/edit','uid'=>$key], [
                    'title' => Yii::t('app', '更新'),
                    'class' => 'btn btn-xs purple'
                ]);
            },
            'auth' => function ($url, $model, $key) {
                return Html::a('<i class="fa fa-user"></i> 授权', ['adminauth/auth','uid'=>$key], [
                    'title' => Yii::t('app', '授权'),
                    'class' => 'btn btn-xs purple'
                ]);
            },
            'delete' => function ($url, $model, $key) {
                return Html::a('<i class="fa fa-times"></i>', ['adminauth/delete', 'id'=>$key], [
                    'title' => Yii::t('app', '删除'),
